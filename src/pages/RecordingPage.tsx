              ...
              {showDiscardConfirm ? (
                <div className="flex items-center justify-between w-full transition-all duration-300">
                  ...
                  <button
                    ...
                    className="w-14 h-14 rounded-full bg-slate-200 hover:bg-slate-300 text-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 flex items-center justify-center cursor-pointer shadow active:scale-95 transition-all duration-200 flex-shrink-0"
                  ...
                  <button
                    ...
                    className="w-14 h-14 rounded-full bg-rose-600 hover:bg-rose-500 flex items-center justify-center cursor-pointer shadow active:scale-95 transition-all duration-200 text-white flex-shrink-0"
