  ...
  return (
    <section className="flex flex-col items-center bg-slate-100 dark:bg-slate-800 rounded-sm max-w-lg mx-auto w-full transition-colors duration-300 animate-fade-in">
      ...
      <div className="pb-4 relative flex items-center justify-center h-28 w-full overflow-visible">
        ...
        {/* 2. Active Recording Controls (Active State) */}
        <div
          className={`flex items-center justify-center transition-all duration-500 ease-out transform ${
            isRecording || isPaused
              ? "opacity-100 scale-100 w-full max-w-md pointer-events-auto"
              : "opacity-0 scale-50 w-0 max-w-0 pointer-events-none overflow-hidden"
          }`}
        >
